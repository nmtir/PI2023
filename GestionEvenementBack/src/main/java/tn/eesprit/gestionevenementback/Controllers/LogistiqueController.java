...
public class LogistiqueController {
    ...
    @PutMapping("/update/depenses/total")
    Logistique updateLogistiqueIncomeAndExpenses(@RequestBody Logistique logistique){
        return logistiqueService.calculDepenses(logistique);
    }
    @GetMapping("/get/{id}")
